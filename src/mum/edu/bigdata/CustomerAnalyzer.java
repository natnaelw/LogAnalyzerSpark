...
public class CustomerAnalyzer {
	...
	public static void main(String[] args) {
		...
		try {
			hdfs = FileSystem.get(new java.net.URI(
					"hdfs://sandbox.hortonworks.com:8020"), hadoopConf);
		...
		// Convert the customer data lines to Customer objects and cache them
		...
		List<Tuple2<String, Long>> topTenCustomers = topTenCustomersRDD
				.collect();
